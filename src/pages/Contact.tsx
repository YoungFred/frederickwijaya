        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-[1.1fr_0.9fr] lg:gap-24">
          <div>
            ...
            <div className="mt-12 space-y-6">
              ...
              <a href="https://shorturl.at/mGSmJ" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 text-lg hover:text-accent transition-colors"><Instagram size={20} className="text-accent" /><span>instagram.com/frederick_wijaya168</span><ArrowUpRight size={18} className="opacity-0 transition-opacity group-hover:opacity-100" /></a>
            </div>
          </div>
